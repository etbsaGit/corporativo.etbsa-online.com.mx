<template>
  <q-form class="q-gutter-y-sm" ref="myForm">
    ...
    <q-item>
      <div style="width: 100%;">
        <q-table flat bordered title="Empleados encontrados" dense :rows="empleados" :columns="columns" row-key="name">
          <template v-slot:top-right>
            <q-btn v-if="empleados.length > 0" color="primary" icon-right="archive" label="Export to csv" no-caps
              @click="exportTable" dense />
          </template>
